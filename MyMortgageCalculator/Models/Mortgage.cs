...
namespace MyMortgageCalculator.Models
{
    /// <summary>
    ...
    public class Mortgage
    {
     /// <summary>
        ...
        public decimal CalculateMonthlyPayment()
        {
            ...
            //var interestMultiplier = (decimal)Math.Pow((double)(1M + monthlyInterestRate), Term);
        ...
        public List<MortgagePayment> GetAmortizationSchedule(decimal? monthlyPayment = null)
        {
            ...
            //var schedule = new List<MortgagePayment>(Term);
            ...
            //for (int index = 0; index < Term; index++)
            {
                ...
                //if (index == Term - 1 && payment.Balance > 0M)
